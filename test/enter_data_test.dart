...
void main() {
  testWidgets('testing the insert song feature', (tester) async{
    ...
    await tester.pumpWidget(MaterialApp(home: Scaffold(body: InsertionPage()))); // this pumps the widget into the tester
    // do
    ...
    await tester.tap(find.text('Classical')); // finds the text 'Classical' and taps it
